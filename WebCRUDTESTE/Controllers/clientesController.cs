...
namespace WebCRUDTESTE.Controllers
{
    public class clientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,NmCliente,Cidade")] cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,NmCliente,Cidade")] cliente cliente)
        {
